"""Skill definitions registry for SU7 CarVoice Fusion.

Contains all function/tool definitions used for intent classification
and function calling in the in-vehicle voice assistant system.
"""
TOOLS: list[dict] = [
    # MEDIA意图
    {
