...
try:
    ...
    _HAS_LANGCHAIN_EMBEDDINGS = True
except ImportError:
    _HAS_LANGCHAIN_EMBEDDINGS = False
...
from app.knowledge.retriever.retriever_base import BaseRetriever
...
faiss_qwen_db_path = _base_dir + "data/saved_index/faiss_qwen.db"
qwen3_embedding_model_path = _base_dir + "models/Qwen3-Embedding-0.6B"
